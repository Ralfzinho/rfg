...
$menuItems = [
    ...
    [
        'href' => '/admin/corridas/listar.php',
        'label' => 'Corridas',
    ...
    [
        'href' => '/admin/corridas/resultados.php',
        'label' => 'Resultados',
    ...
    [
        ...
        [
        'href' => '/admin/corridas/punicao.php',
        'label' => 'Punições',

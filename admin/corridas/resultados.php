  ...
  <div class="bg-white border rounded-2xl p-6 shadow space-y-4">
      <form method="get" class="flex items-end gap-4">
          <div>
              ...
              <select name="corrida_id" class="mt-1 w-full rounded-lg border px-3 py-2" required onchange="this.form.submit()">
      ...
      <form method="post">
                      ...
                      ?>
                          <tr class="border-b">
                              <td class="py-1 pr-3 w-24">
                                  <input name="posicao[]" type="number" class="w-full rounded border px-2 py-1" value="<?= htmlspecialchars($res['posicao'] ?? ($i + 1)) ?>">
                              </td>
                              <td class="py-1 pr-3">
                              ...
                              <td class="py-1 pr-3 w-24">
                                  <input name="pontos[]" type="number" class="w-full rounded border px-2 py-1" value="<?= htmlspecialchars($res['pontos'] ?? '0') ?>">
                              </td>
                          </tr>
                      <?php endfor; ?>
                  </tbody>
          ...
          <div class="flex justify-end gap-3 pt-4">
              <button class="px-5 py-2 rounded bg-primary text-white hover:bg-red-700">Salvar Resultados</button>
          </div>
      </form>
      <?php endif; ?>
  </div>

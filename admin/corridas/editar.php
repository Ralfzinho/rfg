...
<main class="mx-auto max-w-3xl px-4 py-8">
  ...
  <form method="post" class="grid md:grid-cols-2 gap-4 bg-white border rounded-2xl p-6 shadow">
    <div>
      ...
      <input name="nome_gp" required class="mt-1 w-full rounded-lg border px-3 py-2" value="<?= htmlspecialchars($corrida['nome_gp']) ?>">
    </div>
    <div>
    ...
    <div>
      ...
      <input type="date" name="data" required class="mt-1 w-full rounded-lg border px-3 py-2" value="<?= htmlspecialchars($corrida['data']) ?>">
    </div>
    <div>

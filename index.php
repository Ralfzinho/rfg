  ...
  <main>
    ...
    <section class="py-12 bg-gray-900">
      <div class="max-w-7xl mx-auto px-6">
        <h2 class="mb-8 text-center text-3xl md:text-4xl font-extrabold tracking-tight text-white">Destaques</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <!-- Card 1: Giannis Antetokounmpo -->
          <div class="bg-[#1a1a1a] rounded-3xl overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-300">
            <div class="relative h-64">
              <img class="absolute inset-0 w-full h-full object-cover" src="https://i.ibb.co/0j3hX02/giannis.png" alt="Giannis Antetokounmpo">
              <div class="absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-black/80 to-transparent"></div>
              <div class="absolute inset-x-0 bottom-0 p-4">
                <div class="text-white">
                  <p class="text-sm font-bold">NBA PLAYOFFS</p>
                </div>
              </div>
            </div>
                ...
                <div class="absolute -top-16 left-0 right-0 p-4">
                  <div class="flex items-center">
                    <div class="text-white">
                      ...
                      <p class="text-xs">PLACE</p>
                    </div>
                    <div class="ml-4 text-white">
                      <p class="text-2xl font-bold">GIANNIS ANTETOKOUNMPO</p>
                      <p class="text-sm text-gray-400">POWER FORWARD | MILWAUKEE BUCKS</p>
                    </div>
                  </div>
                </div>
                <div class="h-8 bg-green-500 rounded-b-lg -mx-4 mt-16"></div>
              </div>
            </div>
            <div class="p-6 bg-purple-700 text-white rounded-b-3xl">
              <div class="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  ...
                  <p class="text-xs">FG%</p>
                </div>
                <div>
                  <p class="text-3xl font-bold">13</p>
                  <p class="text-xs">REBOUNDS</p>
                </div>
                <div>
                  <p class="text-3xl font-bold">3.7</p>
                  <p class="text-xs">ASSISTS</p>
                </div>
                <div>
                  <p class="text-3xl font-bold">0.7</p>
                  <p class="text-xs">STEALS</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-[#1a1a1a] rounded-3xl overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-300">
            <div class="relative h-64">
              <img class="absolute inset-0 w-full h-full object-cover" src="https://i.ibb.co/M5b09kG/harden.png" alt="James Harden">
              <div class="absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-black/80 to-transparent"></div>
              <div class="absolute inset-x-0 bottom-0 p-4">
                <div class="text-white">
                  <p class="text-sm font-bold">NBA PLAYOFFS</p>
              ...
              <div class="relative">
                <div class="absolute -top-16 left-0 right-0 p-4">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4 text-white">
                      <p class="text-2xl font-bold">JAMES HARDEN</p>
                      <p class="text-sm text-gray-400">SHOOTING GUARD | HOUSTON ROCKETS</p>
                    </div>
                  </div>
                </div>
                <div class="h-8 bg-red-500 rounded-b-lg -mx-4 mt-16"></div>
              </div>
            </div>
            <div class="p-6 bg-purple-700 text-white rounded-b-3xl">
              <div class="grid grid-cols-3 gap-4 text-center">
          ...
          <div class="bg-[#1a1a1a] rounded-3xl overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-300">
            <div class="relative h-64">
              <img class="absolute inset-0 w-full h-full object-cover" src="https://i.ibb.co/d28I29g/kyrie.png" alt="Kyrie Irving">
              <div class="absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-black/80 to-transparent"></div>
              <div class="absolute inset-x-0 bottom-0 p-4">
                <div class="text-white">
                  <p class="text-sm font-bold">NBA PLAYOFFS</p>
              ...
              <div class="relative">
                <div class="absolute -top-16 left-0 right-0 p-4">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4 text-white">
                      <p class="text-2xl font-bold">KYRIE IRVING</p>
                      <p class="text-sm text-gray-400">POINT GUARD | BOSTON CELTICS</p>
                    </div>
                  </div>
                </div>
                <div class="h-8 bg-green-500 rounded-b-lg -mx-4 mt-16"></div>
            ...
            <div class="p-6 bg-purple-700 text-white rounded-b-3xl">
              <div class="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  <p class="text-3xl font-bold">1.2</p>
                  <p class="text-xs">STEALS</p>
                </div>
              </div>
            </div>

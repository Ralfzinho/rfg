...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-center text-gray-800 mb-8">Classificação de Pilotos</h1>
    ...
    <div class="overflow-x-auto bg-white shadow rounded-lg">
        <table class="min-w-full table-auto">
            ...
            <tbody>
                <?php
                // Consulta para a classificação dos pilotos
    ...
    <h1 class="text-3xl font-bold text-center text-gray-800 mt-10 mb-8">Classificação de Equipes</h1>
